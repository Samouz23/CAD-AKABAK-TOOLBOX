...
Point(201) = {-93.250000000, -244.000000000, -244.000000000, 1};
Point(202) = {93.250000000, -244.000000000, -244.000000000, 1};
...
// ==================== Coupe de symétrie ====================
Box(3500) = {-976.000000000, 0.000000000, -254.000000000, 1952.000000000, 976.000000000, 294.000000000};
BooleanIntersection(3600) = { Volume{HV}; Delete; }{ Volume{3500}; Delete; };
HV = 3600;
Box(3501) = {-976.000000000, 0.000000000, -254.000000000, 1952.000000000, 976.000000000, 294.000000000};
...
For _k In {0 : #_hb()-1}
  ...
  If (_s != _ht && _s != _hm)
    ...
    If (!((Fabs(_q(1)) < 0.01 && Fabs(_q(4)) < 0.01)))
...
For _hck In {0 : #_hb()-1}
  ...
  If (((Fabs(_hcq(1)) < 0.01) && (Fabs(_hcq(4)) < 0.01)))
...
For _ick In {2 : #_ie[]-1}
  ...
  If (((Fabs(_icq(1)) < 0.01) && (Fabs(_icq(4)) < 0.01)))
...
For _bck In {0 : #_bb()-1}
  ...
  If (((Fabs(_bcq(1)) < 0.01) && (Fabs(_bcq(4)) < 0.01)))
